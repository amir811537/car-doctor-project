    ...
    <div id="slide1" className="carousel-item relative w-full h-[600px]">
      ...
      <div className="absolute flex items-center rounded-xl h-full left-0 top-0  bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)]">
        <div className="text-white space-y-7 w-1/3  pl-12">
          <h1 className="text-5xl font-extrabold ">Affordable  Price For Car  Servicing</h1>
        <p className="font-bold">There are many variations of passages of  available, but <br /> the majority have suffered alteration in some form</p>
      <div className="flex">
